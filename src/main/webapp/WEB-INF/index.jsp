...
<body>
	...
	<div class="header">
		<div class="container">
			<div class="navbar">
				...
				<nav>
					<ul id="MenuItems">
						...
						<li><a href="/webbangiay/index">Giày nam</a>
							<ul class="sub-ul">
								<c:forEach items="${categoryList }" var="stt">
									<li class="sub-li"><a
										href="/webbangiay/product/nam/${stt.getId() }">${stt.getName()}</a></li>
								</c:forEach>
							</ul></li>

						<li><a href="/webbangiay/index">Giày nữ</a>
							<ul class="sub-ul">
								<c:forEach items="${categoryList }" var="stt">
									<li class="sub-li"><a
										href="/webbangiay/product/nu/${stt.getId() }">${stt.getName()}</a></li>
								</c:forEach>
							</ul></li>
						...
						<li class="shopping-cart"><a class="shopping-cart"
							href="/webbangiay/cart"> <img
			...
			<div class="search-component">
				<form class="search-form" action="/webbangiay/search_product"
					method="POST">
					<input id="search-box" class="search-box" 
						name="search-box" autocomplete="off" oninput="showResult()" />
				...
				<div id="search-result" class="search-result">
					<a onclick="searchFunction(this)" class="response-result">result
						link</a> <a onclick="searchFunction(this)" class="response-result">result
						link</a> <a onclick="searchFunction(this)" class="response-result">result
						link</a> <a onclick="searchFunction(this)" class="response-result">result
						link</a> <a onclick="searchFunction(this)" class="response-result">result
						link</a>
	...
	-->
				<div class="col-4">
					<a href="/webbangiay/productdetail/${stt.getId() }"><img
						src="<c:url value="/resources/images/${stt.getImage() }" />"></a>
					<h4>${stt.getName() }</h4>
					<div class="rating">
	...
	<div class="offer">
		<div class="small-container">
			<div class="row">
				<div class="col-2">
					<img src="<c:url value="/resources/images/exclusive.png" />"
						class="offer-img">
				</div>
				<div class="col-2">
		...
		<div class="small-container">
			<div class="row">
				<div class="col-3">
					...
					<p>Abilities or he perfectly pretended so strangers be
						exquisite. Oh to another chamber pleased imagine do in. Went me
						rank at last loud shot an draw. Excellent so to no sincerity
						smallness. Removal request delight if on he we</p>
					<div class="rating">
						<i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
							class="fa fa-star"></i> <i class="fa fa-star"></i> <i
							class="fa fa-star-o"></i>
		...
		function showResult(){
			...
			$.post({
				...
				success : function(res){
					const a = document.querySelectorAll(".response-result");
					const b = document.querySelector(".search-form");
					for(let i = 0; i < a.length; i++){
						if (res["variable" + i] != null) {
							
							b.style.borderBottom = "groove 2px black";
							a[i].text = res["variable" + i];
							a[i].style.display = "block";
							a[i].href = "/webbangiay/autocomplete_search/" + res["variable" + i] ;
						}else{
		 ...
		 window.addEventListener('click',() => {
			...
			document.querySelector(".search-form").style.borderBottom = "0";
		}); 
