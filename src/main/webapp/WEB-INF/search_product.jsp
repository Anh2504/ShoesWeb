 	...
 	<div class="page-btn">
 		<c:if test="${totalPage > 3 }">
	    	...
	    	<c:if test="${pageIndex > 1}">
	    		<a href="/webbangiay/search_product/1"><span ><<</span> </a>
	    		<a href="/webbangiay/search_product/${pageIndex - 1}"><span ><</span> </a>
	    	</c:if>
	    	
	    	<!-- first page -->
	    	<c:if test="${pageIndex == 1}">
	    		<a href="/webbangiay/search_product/${pageIndex}" ><span style="background-color:#ff523b">${pageIndex}</span> </a>
	    		<a href="/webbangiay/search_product/${pageIndex + 1}"><span >${pageIndex + 1}</span> </a>
	    		<a href="/webbangiay/search_product/${pageIndex + 2}"><span >${pageIndex + 2}</span> </a>
	    	</c:if>
	    	...
	    	<c:if test="${pageIndex < totalPage}">
	    		<a href="/webbangiay/search_product/${pageIndex + 1}"><span >></span> </a>
	    		<a href="/webbangiay/search_product/${totalPage}"><span >>></span> </a>
	    	</c:if>
	    </c:if>
	    <c:if test="${totalPage <= 3 }">
	    	<c:forEach var = "i" begin = "1" end = "${totalPage }">
	    		<a href="/webbangiay/search_product/${i}"><span >${i}</span> </a>
	    	</c:forEach>
	    </c:if>
    </div>
